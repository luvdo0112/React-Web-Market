...
import blog from '@/../public/img/Footer/blog.svg';
import naverpost from '@/../public/img/Footer/naverpost.svg';
import youtube from '@/../public/img/Footer/youtube.svg';
import logo_isms from '@/../public/img/Footer/logo_isms.svg';
import logo_privacy from '@/../public/img/Footer/logo_privacy.svg';
import logo_tosspayments from '@/../public/img/Footer/logo_tosspayments.svg';
import logo_wooriBank from '@/../public/img/Footer/logo_wooriBank.svg';
    ...
    <footer className={classes.footer}>
      <div className={classes.footerInner}>
        <div className={classes.footerInnerTop}>
          <section className={classes.customerCenter}>
            ...
            <ul>
              ...
              <li className={classes.item}>
                <a className={classes.itemTitle} href="/">
                  카카오톡 문의
                </a>
              ...
              <li className={classes.nonMember}>
                <p>
                  비회원 문의 :{' '}
                  <a href="mailto:help@boblion.com">help@boblion.com</a>
                </p>
                <p>
                  비회원 대량주문 문의 :{' '}
                  <a href="mailto:bobgift@boblion.com">help@boblion.com</a>
                </p>
              </li>
            </ul>
          </section>
          <section className={classes.aboutKarly}>
            ...
            <ul className={classes.link}>
              ...
              <li>
                <a href="https://www.youtube.com/embed/WEep7BcboMQ?rel=0&showinfo=0&wmode=opaque&enablejsapi=1">
                  밥사소개영상
                </a>
              </li>
              <li>
              ...
              <li>
                <a href="https://www.kurly.com/user-terms/agreement">
                  이용약관
                </a>
              </li>
              <li>
                <a href="https://www.kurly.com/user-terms/privacy-policy">
                  개인정보처리방침
                </a>
              </li>
              <li>
            ...
            <ul className={classes.info}>
              ...
              <li>
                ...
                <span>
                  제휴문의 :{' '}
                  <a href="mailto:business@boblion.com">business@boblion.com</a>
                </span>
              </li>
              <li>
                채용문의 :{' '}
                <a href="mailto:recruit@karlycorp.com">recruit@boblion.com</a>
              </li>
        ...
        <div className={classes.footerInnerBottom}>
          ...
          <button type="button">
            <img
              alt="ePRIVACY PLUS 인증서 보기"
              className="ePrivacyLogo"
              src={logo_privacy}
            />
            <p>
              개인정보보호 우수 웹 사이트·
          ...
          <button type="button">
            <img
              alt="토스 페이먼츠 정보 보기"
              className="tossPaymentsLogo"
              src={logo_tosspayments}
            />
            <p>
              토스페이먼츠 구매안전(에스크로)
              <br />
      ...
      <div className={classes.footerBottom}>
        ...
        <p>
          밥사에서 판매되는 상품 중에는 밥사에 입점한 개별 판매자가 판매하는
          마켓플레이스(오픈마켓) 상품이 포함되어 있습니다.
          <br />
          마켓플레이스(오픈마켓) 상품의 경우 밥사는 통신판매중개자로서
          통신판매의 당사자가 아닙니다. 밥사는 해당 상품의 주문, 품질, 교환/환불
          등 의무와 책임을 부담하지 않습니다.
        </p>
